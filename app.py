...
def main():
    ...
    if pdf is not None:
        ...
        options = st.multiselect("Select the options to be extracted from the resume: ", ['Name', 'Education', 'Experience', 'Skills', 'Certifications', 'Awards', 'Publications', 'Languages', 'Interests', 'Comprehensive summary', 'Match score'])
        resume = text

        read_resume(jd, resume, options)
